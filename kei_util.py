...
output_var_data_meta = {
    ...
    'PAR_out':{'units':'W m-2','long_name':'total production'},
    ...
    'diat_loss':{'units':'','long_name':'diatom loss'},
    'sp_loss':{'units':'','long_name':'small phytoplankton loss'},
    'diaz_loss':{'units':'','long_name':'diazotroph loss'},
    'diat_agg':{'units':'','long_name':'diatom aggregation'},
    'sp_agg':{'units':'','long_name':'small phytoplankton aggregation'},
    'FG_CO2':{'units':'','long_name':'air-sea co2 flux'},
    'POC_PROD':{'units':'','long_name':'POC production'},
    'POC_REMIN':{'units':'','long_name':'POC remineralization'},
    'DOC_prod':{'units':'','long_name':'DOC production'},
    'DOC_remin':{'units':'','long_name':'DOC remineralization'},
    'CaCO3_PROD':{'units':'','long_name':'CaCO3 production'},
    'CaCO3_REMIN':{'units':'','long_name':'CaCO3 remineralization'},
    'dust_FLUX_IN':{'units':'','long_name':'vertical dust flux'},
    ...
    'POC':{'units':'mmol C m-3','long_name':'particulate organic C'},
    ...
    'runoff':{'units':'mmol Fe m-2 s-1','long_name':'glacial iron flux'},
    'icefe':{'units':'mmol Fe m-2 s-1','long_name':'sea-ice iron flux'},
